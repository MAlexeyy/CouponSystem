...
public class Testing {
	...
	public static void Test(String[] args) {
		...
		// Poppulating Company table with
		// data.-----------------------------------------------------------------------------------------------------------------
		...
		Coupon coupon1 = new Coupon(CouponType.FOOD, "COUPON1 TITLE", "COUPON DESCRIPTION", DateConfig.dateNow(), null,
				10, 100, "www.image.com/picture.jpg");
		Coupon coupon2 = new Coupon(CouponType.RESTAURANT, "COUPON2 TITLE", "COUPON DESCRIPTION", DateConfig.dateNow(),
				null, 20, 200, "www.image.com/picture.jpg");
		Coupon coupon3 = new Coupon(CouponType.FOOD, "COUPON3 TITLE", "COUPON DESCRIPTION", DateConfig.dateNow(), null,
				30, 300, "www.image.com/picture.jpg");
		Coupon coupon4 = new Coupon(CouponType.RESTAURANT, "COUPON4 TITLE", "COUPON DESCRIPTION", DateConfig.dateNow(),
				null, 40, 400, "www.image.com/picture.jpg");
		Coupon coupon5 = new Coupon(CouponType.ELECTRICITY, "COUPON5 TITLE", "COUPON DESCRIPTION", DateConfig.dateNow(),
				null, 50, 500, "www.image.com/picture.jpg");
		Coupon coupon6 = new Coupon(CouponType.VACATION, "COUPON6 TITLE", "COUPON DESCRIPTION", DateConfig.dateNow(),
				null, 60, 600, "www.image.com/picture.jpg");

		try {
			companyService.addCoupon(coupon1, 1);
			companyService.addCoupon(coupon1, 2);
		...
		System.out.println(adminService.getOneCompany(1).get().getCoupons());
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
		System.out.println(adminService.getOneCompany(2).get().getCoupons());
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
		System.out.println(adminService.getOneCompany(3).get().getCoupons());
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
